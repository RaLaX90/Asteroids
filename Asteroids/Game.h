...
private:
	...
	uniform_int_distribution<Uint16> m_distribution_screen_width;	// object for random distribution of width
	uniform_int_distribution<Uint16> m_distribution_screen_height;// object for random distribution of height

	uniform_int_distribution<Uint8> m_distribution_direction_x;
	uniform_int_distribution<Uint8> m_distribution_direction_y;
